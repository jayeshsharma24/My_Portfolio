...
const Detail = () => {
  ...
  return (
    <div className='bg-white min-h-screen overflow-hidden'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5 justify-items-center'>
            <div>
                <img src={detail.image} alt="" className='w-[100px] sm:w-[150px] md:w-[200px] lg:w-[250px] h-auto'/>
            </div>
